...
type TabNames = "About" | "Tech Stack" | "Projects";
interface Tabs {
  tabName: TabNames;
...
const Navbar = () => {
  ...
  return (
    <nav className="h-[var(--navigation-height)] cursor-pointer flex  border-b border-primary-300  fixed w-full backdrop-blur-lg z-10 lg:pr-24 ">
      <img
        src={logoImg}
        alt="logo"
      ...
      <ul
        className={cn(
          "h-full flex flex-1 items-center justify-center relative after:bg-green-400 after:absolute after:w-[25%] after:bottom-0 after:left-0 after:h-[3px] after:transition after:duration-500  after:rounded-lg after:translate-x-0 select-none ",
          {
